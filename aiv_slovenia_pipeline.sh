...
~/programs/vapor/vapor.py --return_best_n 100 -fq ${trimFile1} ${trimFile2} -fa ~/CourseData/Refs/HA_AIV_Europe.fasta > vapor_results_HA.txt
~/programs/vapor/vapor.py --return_best_n 100 -fq ${trimFile1} ${trimFile2} -fa ~/CourseData/Refs/NA_AIV_Europe.fasta > vapor_results_NA.txt
